 ...
 const btnAdd = document.getElementsByClassName("item-btn");
...
class UI{
    ...
    cartCount(){
        ...
        let counter = document.getElementById("item-count");
        counter.innerHTML = cartListItem.length;
...
for (let i  = 0; i  < card.length; i ++) {
    btnAdd[i].addEventListener("click", function(e){
        ...
        btnAdd[i].textContent = "Added to the cart"
